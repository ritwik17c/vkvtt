...
(function(){
  ...
  function registerThemeShell(){if(!('serviceWorker' in navigator)||location.protocol==='file:')return;navigator.serviceWorker.register('./sw.js?v=20260909-production-main1',{scope:'./'}).catch(e=>console.info('[VKVTT theme] shell registration skipped:',e?.message||e))}
  function mount(){
