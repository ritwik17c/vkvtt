...
(function(){
  ...
  function allThemeLinks(doc=document){
    const bg=ensureCss(doc,'vkvBlackGoldThemeCss','./vkv-black-gold-screen.css?v=20260919-proxy-disabled-light-1');
    const lt=ensureCss(doc,'vkvLightThemeCss','./vkv-light-screen.css?v=20260919-proxy-disabled-light-1');
